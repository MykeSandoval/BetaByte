...
function Product() {
  ...
  const navigationHierarchy = [
    ...
    { label: "TARJETAS GRAFICAS", to: `/categorias/componentes-pc/producto/${id}` },
  ];
          ...
          <div className="main-image">
            ...
            {images.map((image, index) => (
                <img
                  ...
                  className={`px- max-h-24 px-5 mb-5 border border-gray-300 rounded-sm cursor-pointer ${image === selectedImage ? "selected" : "opacity-50"}`}
  ...
  <div className="container-price flex flex-col p-4 border-b border-gray-300">
    <span className="text-2xl font-semibold mb-2">Tarjeta Grafica NVIDIA RTX4090</span>
    ...
    <img src="/public/credit/Visa.png" alt="Tarjeta de credito" className="py-2 w-40 h-15" />
    <div>
      <button
      ...
      {modalIsOpen && (
        ...
        <div className="modal-content bg-white p-4 rounded-lg shadow-lg relative">
          ...
          <p className="border-b mb-4 pb-5">Descripción detallada de los métodos de pago disponibles para este producto.</p>
          <h1 className="text-base font-semibold pb-2">Tarjetas de crédito</h1>
          <p className="text-base text-gray-500 pb-6">Acreditación instantánea.</p>
          <h2 className="text-base font-medium pb-4">Hasta 48 cuotas con interés</h2>
          <div className="flex flex-wrap gap-20">
          <img src="/public/credit/VISA-Logo.png" alt="VISA" className="w-10 h-5"/>
          <img src="/public/credit/MasterCard-Logo.png" alt="MasterCard" className="w-10 h-5"/>
          <img src="/public/credit/american-express-logo.png" alt="American" className="w-10 h-5"/>
          <img src="/public/credit/Diners_Club-logo.png" alt="Diners" className="w-10 h-5"/>
          </div>
          ...
          <h1 className="text-base font-semibold pb-2">Tarjetas de debito</h1>
          <p className="text-base text-gray-500 pb-6">Acreditación instantánea.</p>
          <div className="flex flex-wrap gap-20  border-b mb-4 pb-8">
          <img src="/public/credit/Visa-debito.png" alt="VISA, debito" className="w-10 h-5"/>
          <img src="/public/credit/MasterCard-debito.png" alt="MasterCard, debito" className="w-10 h-5"/>
          </div>
          <h2 className= "text-xl font-semibold pb-2" > Otros medios de pago</h2>
          
      </div>
      </div>
    )}
  </div>
    <button className="btn-clean bg-gray-100 mt-2 py-2 px-4 border border-gray-300 rounded text-gray-600 hover:text-gray-900 hover:bg-gray-200">
      Limpiar
    </button>
  </div>
</div>
      ...
      <section className="container-related-products">
        ...
        <div className="card-list-products grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Listado de productos relacionados aquí */}
        </div>
      </section>
